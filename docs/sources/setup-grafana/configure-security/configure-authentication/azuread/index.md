...
<<<<<<<< HEAD:docs/sources/setup-grafana/configure-security/configure-authentication/azuread.md
1. Add the following to the [Grafana configuration file]({{< relref "../../configure-grafana/#config-file-locations" >}}):
========
1. Add the following to the [Grafana configuration file]({{< relref "../../../configure-grafana/#config-file-locations" >}}):
>>>>>>>> v9.3.1:docs/sources/setup-grafana/configure-security/configure-authentication/azuread/index.md
